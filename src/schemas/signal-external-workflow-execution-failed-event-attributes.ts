...
export const SignalExternalWorkflowExecutionFailedEventAttributesSchema =
  z.object({
    cause: z
      .enum([
...
export type SignalExternalWorkflowExecutionFailedEventAttributesSchema =
  z.infer<typeof SignalExternalWorkflowExecutionFailedEventAttributesSchema>;
