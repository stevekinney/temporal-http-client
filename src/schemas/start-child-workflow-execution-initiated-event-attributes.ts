...
export const StartChildWorkflowExecutionInitiatedEventAttributesSchema =
  z.object({
    /**
...
export type StartChildWorkflowExecutionInitiatedEventAttributesSchema = z.infer<
  typeof StartChildWorkflowExecutionInitiatedEventAttributesSchema
>;
